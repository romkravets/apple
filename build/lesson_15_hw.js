...
var MenuReact = exports.MenuReact = function (_React$Component) {
  _inherits(MenuReact, _React$Component);

  function MenuReact() {
    _classCallCheck(this, MenuReact);

    var _this = _possibleConstructorReturn(this, (MenuReact.__proto__ || Object.getPrototypeOf(MenuReact)).call(this));
  ...
  _createClass(MenuReact, [{
    ...
    value: function render() {
      ...
      var classSidebar = "menu__sidebar ";

      if (this.state.isOpened) {
        classSidebar += 'menu__open_btn';
      }

      var listItems = this.state.menu.map(function (item, i) {
        return React.createElement(
          'li',
          { key: i, className: 'menu__item' },
          React.createElement(
            'a',
            { href: item.href, className: 'menu__link' },
            React.createElement(
              'span',
              null,
              item.title
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { className: 'menu__link menu__close_btn', onClick: this.toggleMenu },
            '\xD7'
          ),
          React.createElement(
            'ul',
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            { className: 'menu__btn menu__open_btn', onClick: this.toggleMenu },
            '\u2630 React menu'
          )
        )
      );
...
var _MenuReact = __webpack_require__(106);

var _CommentsList = __webpack_require__(406);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'page' },
        React.createElement(_MenuReact.MenuReact, null),
        React.createElement(
          'div',
...
var _httpService = __webpack_require__(407);
...
var CommentsList = exports.CommentsList = function (_React$Component) {
  ...
  _createClass(CommentsList, [{
    ...
    value: function onSubmit(e) {
      ...
      e.preventDefault();
      var title = this.state.newcommentTitle;

      this.httpService.post(URL, { title: title }, function (comment) {
    ...
    key: 'render',
    value: function render() {
      var listItems = this.state.comments.map(function (comment, i) {
        return React.createElement(
          'li',
          { className: 'comment__items', key: i },
          comment.title
        );
      });
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'comment__lists' },
            listItems
          ),
          React.createElement(
            'div',
            { className: 'comment__forms' },
            React.createElement(
              'form',
              { className: 'comment__form', onSubmit: this.onSubmit },
...
*/
var aa=__webpack_require__(19),n=__webpack_require__(31),da=__webpack_require__(53);function ea(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
